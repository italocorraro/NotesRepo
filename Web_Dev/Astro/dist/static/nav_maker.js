...
const navbar = [
  ...
  },
  {
    ...
    content: [
      ...
      { name: 'Collezioni Indicizzate', URL: astro + 'javascript/Collezioni Indicizzate/' },
      { name: 'Classi', URL: astro + 'javascript/Classi/' },
      { name: 'Catena dei Prototìpi', URL: '#' },
  ...
  },
  {
    ...
    content: [
      ...
      { name: 'UI Events API', URL: astro + 'APIs/Eventi/' },
      { name: 'Storage API', URL: '#' },
      { name: 'URL API', URL: '#' },
      { name: 'View Transition API', URL: '#' },
      { name: 'Intersection Observer API', URL: '#' },
      { name: 'Pointer Events', URL: '#' },
    ]
  },
  {
