...
<!--        Lista pagine HTML                          -->
            ...
            <ul class="panel">
                <li><a href="../../html/Sintassi html/">Sintassi</a></li>
                <li><a href="../../html/Struttura Semantica/">Struttura Semantica</a></li>
                <li><a href="../../html/L'elemento head/">L'elemento &lt;head&gt;</a></li>
                <li><a href="../../html/Ancore/">Ancore</a></li>
...
<!--        Lista pagine JS                          -->
            ...
            <ul class="panel">
                ...
                <li><a>Oggetti</a></li>
                <li><a>Mappe</a></li>
                <li><a href="#">Espressioni Regolari</a></li>
                <li><a>Debug</a></li>
                <li><a>Eventi</a></li>
...
<!--        Lista pagine Markdown                         -->
            ...
            <ul class="panel">
                <li><a href="https://github.com/italocorraro/NotesRepo/blob/main/Markdown/Sintassi%20md.md">Sintassi</a></li>
            </ul>
<!--        Lista pagine Vite                         -->
            <li class="flip" hidden>
                <span>Vite</span>
